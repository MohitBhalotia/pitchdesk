...
import { listFactsForRoom } from "@/lib/services/startupFacts";
...
export async function GET(_req: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    const facts = await listFactsForRoom(userId, roomId);
    if (facts === null) {
    ...
    return toErrorResponse(error, "Error listing startup facts:");
  }
}
