                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="bg-card rounded-2xl p-6 sm:p-8 md:p-10 shadow-lg border border-border">
                            ...
                            <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 mt-8">
                                ...
                                <div className="text-center p-4 sm:p-6 bg-primary/5 rounded-xl border border-primary/20">
                                    <div className="text-3xl sm:text-4xl font-bold text-primary mb-2">Editable</div>
                                    <p className="text-sm sm:text-base text-muted-foreground">Customize every slide</p>
                                </div>
                                <div className="text-center p-4 sm:p-6 bg-primary/5 rounded-xl border border-primary/20">
                                    <div className="text-3xl sm:text-4xl font-bold text-primary mb-2">Export</div>
