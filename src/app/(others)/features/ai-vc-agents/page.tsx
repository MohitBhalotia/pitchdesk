                ...
                <section className="container mx-auto px-4 py-12 sm:py-16 md:py-20">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
                            <span className="text-primary">Build AI VC Judges</span> Tailored to Your Thesis
                        </h1>
                        ...
                        <div className="bg-card rounded-2xl p-8 md:p-10 shadow-lg border border-border">
                            ...
                            <div className="grid md:grid-cols-3 gap-6 mt-8">
                                <div className="text-center p-6 bg-primary/5 rounded-xl">
                                    ...
                                    <p className="text-muted-foreground">Customizable to your thesis</p>
                                </div>
                                <div className="text-center p-6 bg-primary/5 rounded-xl">
                                    <div className="text-4xl font-bold text-primary mb-2">24/7</div>
                                    <p className="text-muted-foreground">Autonomous screening</p>
                                </div>
                                <div className="text-center p-6 bg-primary/5 rounded-xl">
                                    <div className="text-4xl font-bold text-primary mb-2">Consistent</div>
                                    <p className="text-muted-foreground">No bias or fatigue</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-8">
                            <div className="flex gap-6 items-start">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-foreground mb-2">Define Your Investment Criteria</h3>
                            ...
                            <div className="flex gap-6 items-start">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-foreground mb-2">Customize Evaluation Rubric</h3>
                                    <p className="text-muted-foreground leading-relaxed">
                            ...
                            <div className="flex gap-6 items-start">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-foreground mb-2">Set Agent Personality</h3>
                                    <p className="text-muted-foreground leading-relaxed">
                            ...
                            <div className="flex gap-6 items-start">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-foreground mb-2">Deploy & Use</h3>
                                    <p className="text-muted-foreground leading-relaxed">
                            ...
                            <div className="flex gap-6 items-start">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-foreground mb-2">Refine Over Time</h3>
                                    <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="bg-card rounded-xl p-6 shadow-lg border border-border">
                                ...
                                <h3 className="text-xl font-bold text-foreground mb-3">Your Thesis, Your Agent</h3>
                            ...
                            <div className="bg-card rounded-xl p-6 shadow-lg border border-border">
                                ...
                                <h3 className="text-xl font-bold text-foreground mb-3">Consistent Evaluation</h3>
                                <p className="text-muted-foreground">
                            ...
                            <div className="bg-card rounded-xl p-6 shadow-lg border border-border">
                                ...
                                <h3 className="text-xl font-bold text-foreground mb-3">Scale Your Screening</h3>
                                <p className="text-muted-foreground">
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="bg-card rounded-xl p-6 border border-border">
                                <h3 className="text-xl font-bold text-foreground mb-3">The Fintech Focused Agent</h3>
                                ...
                                <p className="text-sm text-muted-foreground italic">Used by: Fintech-focused seed funds</p>
                            </div>

                            <div className="bg-card rounded-xl p-6 border border-border">
                                <h3 className="text-xl font-bold text-foreground mb-3">The Impact-First Agent</h3>
                                <p className="text-muted-foreground mb-4">
                                ...
                                <p className="text-sm text-muted-foreground italic">Used by: Climate tech and impact investors</p>
                            </div>

                            <div className="bg-card rounded-xl p-6 border border-border">
                                <h3 className="text-xl font-bold text-foreground mb-3">The Enterprise SaaS Agent</h3>
                                <p className="text-muted-foreground mb-4">
                                ...
                                <p className="text-sm text-muted-foreground italic">Used by: B2B SaaS-focused VCs</p>
                            </div>

                            <div className="bg-card rounded-xl p-6 border border-border">
                                <h3 className="text-xl font-bold text-foreground mb-3">The DeepTech Agent</h3>
                                <p className="text-muted-foreground mb-4">
                                ...
                                <p className="text-sm text-muted-foreground italic">Used by: DeepTech and hard-science investors</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <Link href="/features/vc-deal-flow" className="bg-card rounded-xl p-6 shadow-md border border-border hover:shadow-xl hover:-translate-y-1 transition-all">
                                ...
                                <p className="text-muted-foreground text-sm">Use your AI agents to automate deal flow screening.</p>
                            </Link>

                            <Link href="/features/investment-programs" className="bg-card rounded-xl p-6 shadow-md border border-border hover:shadow-xl hover:-translate-y-1 transition-all">
                                <Sparkles className="w-10 h-10 text-primary mb-4" />
                                <h3 className="text-xl font-bold text-foreground mb-2">Investment Programs</h3>
                                <p className="text-muted-foreground text-sm">Deploy agents in your accelerator programs.</p>
                            </Link>
                            ...
                            <Link href="/features/pitch-competitions" className="bg-card rounded-xl p-6 shadow-md border border-border hover:shadow-xl hover:-translate-y-1 transition-all">
                                ...
                                <p className="text-muted-foreground text-sm">Use agents as judges for competitions.</p>
                            </Link>
                        </div>
                    </div>
                </section>
