...
export default function VerifyEmail({
  ...
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>Pitch Desk Email Verification</Preview>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              ...
              <Text style={mainText}>
                Hi {fullName},
                <br />
                Thanks for signing up for Pitch Desk. We want to make sure it's
            ...
            <Section style={lowerSection}>
              <Text style={cautionText}>
                Pitch Desk will never email you and ask you to disclose or
          ...
          <Text style={footerText}>
            This message was produced and distributed by Pitch Desk, IIIT Nagpur
